...
const DocumentUpload: React.FC<DocumentUploadProps> = ({ form }) => {
  ...
  const currentFiles = form.watch("projectDocuments") || [];
  ...
  const handleFiles = (files: FileList) => {
    ...
    if (validFiles.length > 0) {
      ...
      form.setValue("projectDocuments", updatedFiles);
    }
  };
  ...
  return (
    <div className="bg-surface border-border rounded-lg border p-4">
      ...
      <div className="bg-muted mt-4 rounded-md p-3">
        ...
        <div className="text-text-secondary grid grid-cols-1 gap-2 text-xs md:grid-cols-3">
          <div>
